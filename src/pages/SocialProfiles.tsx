  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {profiles.length === 0 && !isAddingNew ? (
        <Card className="border-dashed border-2 p-8 mt-8">
                  ...
                  return (
                    <Card key={profile.id} className="overflow-hidden border hover:shadow-md transition-shadow">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {profile.status === 'pending' && (
                                <DropdownMenuItem onClick={() => verifyProfile(profile.id)}>
                      ...
                      <CardFooter className="justify-between border-t pt-3 pb-3">
                        ...
                        {profile.status === 'pending' ? (
                          <Button variant="outline" size="sm" className="text-xs bg-yellow-500/10 border-yellow-500/30 text-yellow-500 hover:text-yellow-600 hover:bg-yellow-500/20" onClick={() => verifyProfile(profile.id)}>
                            <AlertCircle size={14} className="mr-1" /> Verify
                          </Button>
                        ) : (
                          <Button variant="outline" size="sm" className="text-xs text-red-500 hover:text-red-600 hover:bg-red-500/10" onClick={() => deleteProfile(profile.id)}>

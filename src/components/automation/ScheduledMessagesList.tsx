  ...
  return (
    <ScrollArea className="flex-1 h-full">
      <div className="p-3">
        ...
        <button 
          className="w-full py-2 mt-2 mb-4 border border-border rounded-md text-sm flex items-center justify-center gap-2 text-muted-foreground hover:text-foreground hover:bg-secondary/30 transition-colors"
